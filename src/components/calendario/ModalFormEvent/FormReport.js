...
const FormReport = ({ report, day, isModalOpen }) => {
  ...
  const report_event_types = useSelector((state) => state.report.report_event_types.report_event_types);
  ...
  const onDelete = () => {
    ...
    confirm_alert += report_event_types.find((element) => element.id === report.report_event_type).name + "?";
      ...
      render={({ handleSubmit, form }) => (
        <form onSubmit={handleSubmit} className="needs-validation" noValidate>
                  ...
                  <div className="form-inline">
                    ...
                    >
                      ...
                      {report_event_types.map((report_event_type, index) => (
                        <option key={report_event_type.id} value={report_event_type.id}>
          ...
          <CommonModalFooter
            ...
            canDelete={report !== undefined ? (report.id !== 0 ? true : false) : false}
            canCopy={report !== undefined ? (report.id !== 0 ? true : false) : false}
            onDelete={onDelete}
            form={form}
          />
        </form>
